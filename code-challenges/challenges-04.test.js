...
Write a function called addTwo that takes in an array
 and adds two to every value using a for loop.
...
all words that begin with a capital letter. It should only match words,
 not punctuation.
