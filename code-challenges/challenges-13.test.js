...
Write a function named longestString that takes in an array of strings and returns the 
index position of the longest string. 
------------------------------------------------------------------------------------------------ */
...
const allHappy = (arr) => {
  // Solution code here...
  let init = 0;
  arr.forEach(str => str.includes(':)') ? init++:init );
  return init === arr.length;
};
